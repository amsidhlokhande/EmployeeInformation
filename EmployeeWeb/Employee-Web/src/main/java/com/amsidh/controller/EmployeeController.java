...
public class EmployeeController {
	...
	public ModelAndView saveEmployee(@ModelAttribute(value = "employee") EmployeeBean employeeBean,
	...
	public ModelAndView addEmployee(@ModelAttribute(value = "employee") EmployeeBean employee, BindingResult result) {
		...
		model.addObject("employees",
				EmployeeControllerHelper.employeeDtosToEmployeeBeans(employeeService.listEmployeess()));
		model.setViewName("addEmployee");
		return model;
	}

	@RequestMapping(value = "/delete", method = RequestMethod.GET)
	public ModelAndView deleteEmployee(@ModelAttribute(value = "employee") EmployeeBean employeeBean,
			BindingResult result) {
	...
	public ModelAndView editEmployee(@ModelAttribute("employee") EmployeeBean employeeBean, BindingResult result) {
		System.out.println("Inside deleteEmployee method");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("employee", EmployeeControllerHelper
				.employeeDtoToEmployeeBean(employeeService.getEmployee(employeeBean.getEmpId())));
		model.put("employees", EmployeeControllerHelper.employeeDtosToEmployeeBeans(employeeService.listEmployeess()));
		return new ModelAndView("addEmployee", model);
